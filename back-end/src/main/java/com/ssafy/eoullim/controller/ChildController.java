...
public class ChildController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@Valid @RequestBody ChildLoginRequest request, Authentication authentication) {
    ...
    @PostMapping("/logout")
    public ResponseEntity<?> logout(@Valid @RequestBody ChildLogoutRequest request, Authentication authentication) {
        User user = ClassUtils.getSafeCastInstance(authentication.getPrincipal(), User.class);
    ...
    @ResponseBody
    public SuccessResponse<?> create(@Valid @RequestBody ChildRequest request, Authentication authentication) {
        User user = ClassUtils.getSafeCastInstance(authentication.getPrincipal(), User.class);
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public SuccessResponse<Child> getChild(@PathVariable @NotBlank Long childId, Authentication authentication) {
        User user = ClassUtils.getSafeCastInstance(authentication.getPrincipal(), User.class);
    ...
    @ResponseBody
    public SuccessResponse<?> modify(@PathVariable @NotBlank Long childId, @Valid @RequestBody ChildRequest request) {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @ResponseBody
    public SuccessResponse<?> delete(@PathVariable @NotBlank Long childId, Authentication authentication) {
        User user = ClassUtils.getSafeCastInstance(authentication.getPrincipal(), User.class);
    ...
    public ResponseEntity<SuccessResponse<OtherChild>> getOtherChild(@PathVariable @NotBlank Long participantId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public SuccessResponse<?> isValidSchool(@Valid @RequestBody ChildSchoolRequest request) {
