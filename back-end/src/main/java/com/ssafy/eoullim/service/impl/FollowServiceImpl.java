...
public class FollowServiceImpl implements FollowService {
    ...
    public void create(Long childId, Long followingId, Authentication authentication) {
        ...
        if (childId.equals(followingId)) throw new IllegalArgumentException("id가 같은 child끼리는 친구 할 수 없음.");
        ...
        followRepository.findByChildAndFollowingChild(childEntity, followingChildEntity)
